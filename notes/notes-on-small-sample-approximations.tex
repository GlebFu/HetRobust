...
\bm{Q} = \left(\bm{I} - \bm{H}\right)\bs\Sigma\left(\bm{I} - \bm{H}\right), \qquad \bm{z}_q = \left(\bm{I} - \bm{H}\right)\bs\Sigma \bm{g}, \qquad a = \frac{\sum_{i=1}^n g_{qi}^2 z_{qi}^2 / \omega_i^2 }{\left(\sum_{i=1}^n g_{qi}^2 \sigma_i^2\right)^2}, \qquad b = \frac{\sum_{i=1}^n g_{qi}^2  q_{ii} / \omega_i^2}{\sum_{i=1}^n g_{qi}^2 \sigma_i^2} - 1. \]
