...
edm <- function() {
  ...
  EnES <- data.frame(dist = "En", En * ESs)
  EchES <- data.frame(dist = "Ech", Ech * ESs)
  EtES <- data.frame(dist = "Et", Et * ESs)
...
EDists <-  melt(EDists, id.vars = "dist", variable.name = "EStructs", value.name = "x")
