...
The design of the simulation study is modeled on the earlier study of \citet{Long2000using}.\todo{Outline paper}
...
\citet{Bell2002bias} developed a similar test (also based on a Satterthwaite approximation) for linear regressions with data from multi-stage samples, in which the error structure may be both heteroskedastic and dependent within clusters of observations. 
