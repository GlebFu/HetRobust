...
Although all the approximations appear promising, it is not clear on the basis of their derivation which approach is most accurate with small samples, nor whether any of the approaches represents an improvement on conventional practice. 
...
In the following section, we report two simulation studies that investigate the performance the distributional approximations under a range of conditions. 
