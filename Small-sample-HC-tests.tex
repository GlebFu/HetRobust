...
\end{equation}
where $\omega_{1},...,\omega_{n}$ are correction terms that differ for the various HC estimators. 
...
Subsequently, various correction factors have been proposed in order to improve on the finite-sample behavior of HC0. 
