...
Let $\bs{\hat\beta} = \mat{M}\mat{X}'\mat{y} / n$ denote the vector of OLS estimates and $e_i = y_i - \mat{x}_i \bs{\hat\beta}$, $i = 1,...,n$ denote the residuals. 
