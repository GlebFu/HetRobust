...
results <- rbind(read.csv("20150915A.csv"),
                 read.csv("20150915C.csv"),
                 read.csv("20150915D.csv"),
                 read.csv("20150915B.csv"))

#results <- rbind(read.csv("Results/Model 2/20150915A.csv"),
#                 read.csv("Results/Model 2/20150915C.csv"),
#                 read.csv("Results/Model 2/20150915D.csv"),
#                 read.csv("Results/Model 2/20150915B.csv"))
...
```{r, cache = T, echo = F, warning = F, results = "asis", fig.width = 15, fig.height = 15}
filter(results, test != "edgeKC", criterion == "size", HC == "HC2" | HC == "HC3") %>%
  select(n, Estruct, Edist, HC, coef, test, p05) %>%
  ggplot(aes(y = p05,
             x = test,
             color = test)) +
...
results2 <- filter(results, test != "edgeKC", criterion == "size") %>%
  select(n, Estruct, Edist, HC, coef, test, p05) %>%
