...
test2 <- as.data.frame(test[,c(1,12)])
test2 <- test2[test2[,2] == 3.81,]
paste(test2[,1], collapse = ", ")

test3 <- filter(PIR, method == "naive_HC3") %>%
  select(n:p05, edgeKC_HC3, edgeKC_HC4m, naive_HC4m, saddle_V1_HC3, 
         saddle_V1_HC4, saddle_V1_HC4m, saddle_V2_HC3, saddle_V2_HC4, 
         saddle_V2_HC4m, Satt_HC3, Satt_HC4m)
